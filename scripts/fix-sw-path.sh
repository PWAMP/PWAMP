...
sed "s/$OLD_REPLACE/$NEW_REPLACE/g" build/default/amp/index.html | sed "s/$OLD_REPLACE1/$NEW_REPLACE1/g" > tmp
mv tmp build/default/amp/index.html

OLD_REPLACE='\/service-worker.js'
NEW_REPLACE='https:\/\/pwamp.github.io\/service-worker.js'
sed "s/$OLD_REPLACE/$NEW_REPLACE/g" build/default/sw.html > tmp
mv tmp build/default/sw.html